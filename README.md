...
- **Oracle & rune archive** — the completed monolith is an **oracle**: significant achievements (tradition forged, prophecy fulfilled, first predator slain, a new generation's firstborn) are carved as **permanent runes** (`!monument`), and colonists who `Interact` with *pray* at Camp gain divine inspiration (+8 morale, +1 XP to their weakest skill) — and in the cold, a *Divine Warmth* blessing that shields them from frost
